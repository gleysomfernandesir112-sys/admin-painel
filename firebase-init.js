...
export { initializeApp, deleteApp, auth, getAuth, signInWithEmailAndPassword, onAuthStateChanged, signOut, createUserWithEmailAndPassword, db, ref, set, get, onValue, remove, update };